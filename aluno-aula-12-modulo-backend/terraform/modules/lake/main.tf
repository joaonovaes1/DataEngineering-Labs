# =============================================================================
# modulo lake — os SEIS recursos, recortados da raiz sem uma unica alteracao.
# Nomes preservados: renomear qualquer um deixaria de casar com o estado movido
# pelo terraform state mv e viraria recriacao.
# =============================================================================
